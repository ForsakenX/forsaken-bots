...
module EventMachine
  ...
  def EventMachine::connect server, port, handler=nil
    ...
    # handler can be a Module which gets mixed in
    # or it can be a class which sub classes EM::Connection
    # or it can be an instance of an object
         # which reproducts a fake new method
         # thats consists of
         # def new(sig)
         #   @signature = sig
         #   post_init
